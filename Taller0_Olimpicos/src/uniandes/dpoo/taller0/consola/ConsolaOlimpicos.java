...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais del atleta que quiera buscar:");
	...
	{
	String atleta = input("Digite el nombre del atleta");
	String nombre = calculadora.buscarAtletaPais(atleta);
	System.out.println("El pais del atleta el cual busco es:" + nombre);
	}
	/**
